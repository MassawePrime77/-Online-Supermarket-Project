...
<html lang="en">
	<head>
	    ...
	    <title>Blessed J' Online Minimarket</title>
	    ...
	    <link rel="stylesheet" href="assets/css/dark-cyan.css">
		...
		<link href="assets/css/dark=cyan.css" rel="alternate stylesheet" title="Darkcyan color">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/sn01.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/slide01.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Get the best services</h4>
						</div>
					</div>	
					<h6 class="text">Quality Products.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Order shipping Available</h4>
						</div>
					</div>
					<h6 class="text">Get your orders shiped at affordable prices</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Packaging Assured</h4>
						</div>
					</div>
					<h6 class="text">All items-are packaged appropriately </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Our Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#books" data-toggle="tab">Food</a></li>
					<li><a href="#furniture" data-toggle="tab">Detergents</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Margarine</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="1">
	<?php
$ret=mysqli_query($con,"select * from products where category=3 and subCategory=9");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Body Care</h3>
