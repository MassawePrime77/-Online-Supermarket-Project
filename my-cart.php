...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Ksh"." ".$row['shippingCharge']; ?>.00</span></td>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo "Ksh".($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00</span></td>
				</tr>
...
<div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Billing County   <span>*</span></label>
...
<div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Shipping County  <span>*</span></label>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Grand Total (Ksh.)<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
